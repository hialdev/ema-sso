...
var baseDest = './www/admin/assets/';
var jsonManifest = 'rev-manifest-admin.json';
...
var srcVendorJS = [
    ...
    './webassets/plugins/socketio/socket.io.js',
...
var srcMapJS = [
    ...
    './webassets/plugins/socketio/socket.io.js.map',
];

var srcAppJS = [
    './webassets/js/apps/application.js',

    './webassets/js/apps/admin/dashboard.js',
    './webassets/js/apps/admin/manage.application.js',
    './webassets/js/apps/admin/manage.account.js',
    './webassets/js/apps/admin/manage.employee.js',
    './webassets/js/apps/admin/setting.js',
];
