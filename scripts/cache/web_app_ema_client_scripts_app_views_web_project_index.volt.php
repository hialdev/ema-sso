...
<div class="container-xxl flex-grow-1 container-p-y">       
    <div class="row py-3">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card mb-4">
                <div class="card-body">
                    <a href="<?= $this->url->get('project/project-dummy') ?>" class="text-dark text-decoration-none d-block">
                        ...
                        <div class="d-flex">
                            <a href="<?= $this->url->get('note/p/project-dummy') ?>" class="mt-3 me-2 btn btn-outline-secondary w-100 d-flex align-items-center gap-2 justify-content-center"><span class="iconify" data-icon="ic:round-sticky-note-2"></span> Note</a>
                            <a href="<?= $this->url->get('project/project-dummy') ?>" class="mt-3 btn btn-primary w-100 d-flex align-items-center gap-2 justify-content-center">Detail <span class="iconify" data-icon="bi:arrow-right-circle-fill"></span></a>
                        </div>
                    </a>
                </div>
            </div>
