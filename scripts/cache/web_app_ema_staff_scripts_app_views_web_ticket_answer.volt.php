...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="py-3">
        <a href="<?= $this->url->get('ticket') ?>" class="d-inline-flex align-items-center gap-2 mb-3"><span class="iconify fs-2" data-icon="ion:arrow-back-circle"></span> Back to Ticket</a>
            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    <tbody class="table-border-bottom-0">
                        ...
                        <?php $v139727521992174358071iterated = false; ?><?php foreach ($chats as $chat) { ?><?php $v139727521992174358071iterated = true; ?>
                        <tr>
                            <td colspan="10">
                        ...
                        <?php } if (!$v139727521992174358071iterated) { ?>
                        <tr>
                            <td colspan="10">
                                <div class="card bg-light">
