                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled">
                            <?php $v161760282364944569681iterated = false; ?><?php foreach ($project->Tasks as $task) { ?><?php $v161760282364944569681iterated = true; ?>
                            ...
                            <?php } if (!$v161760282364944569681iterated) { ?>
                            <li>
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table">
                            ...
                            <tbody class="table-border-bottom-0">
                                <?php $v161760282364944569681iterated = false; ?><?php foreach ($tickets as $ticket) { ?><?php $v161760282364944569681iterated = true; ?>
                                <tr>
