...
<div class="container-xxl flex-grow-1 container-p-y">  
    <div class="py-3">
        ...
        <div class="d-flex flex-column flex-md-row gap-2 align-items-start justify-content-between">
            ...
            <a href="<?= $this->url->get('note/p/project-dummy') ?>" class="btn btn-secondary d-inline-flex align-items-center gap-2 "><span class="iconify" data-icon="ic:round-sticky-note-2"></span> Notes</a>
        </div>
        <div class="row">
            <div class="col-6">
                <div class="card">
