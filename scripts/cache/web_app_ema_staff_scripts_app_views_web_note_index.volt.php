...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="py-3">
        ...
        <div class="row mb-4">
            ...
            <?php $v172087528451037600891iterated = false; ?><?php foreach ($projects as $project) { ?><?php $v172087528451037600891iterated = true; ?>
            ...
            <?php } if (!$v172087528451037600891iterated) { ?>
            <div class="col-12">
                <div class="card">
        ...
        <div class="row">
            ...
            <?php $v172087528451037600891iterated = false; ?><?php foreach ($notes as $note) { ?><?php $v172087528451037600891iterated = true; ?>
