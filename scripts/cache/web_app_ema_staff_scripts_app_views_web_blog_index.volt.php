    ...
    <div class="row py-3">
        <div class="col-12">
            <div class="d-flex mb-3 align-items-center justify-content-between">
                ...
                <a href="<?= $this->url->get('knowladge/add') ?>" class="btn btn-primary">Add New</a>
            </div>
            <form action="">
            ...
            <?php if ($blogs->getFirst() !== $blogs->getLast()) { ?>
            <!-- Basic Pagination -->
        ...
        <?php $v137139430672616585991iterated = false; ?><?php foreach ($blogs->getItems() as $blog) { ?><?php $v137139430672616585991iterated = true; ?>
        ...
        <?php } if (!$v137139430672616585991iterated) { ?>
