                    ...
                    <div class="card-title d-flex align-items-start justify-content-between">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt4">
                                ...
                                <a class="dropdown-item" href="<?= $this->url->get('project/add') ?>">Add New</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt4">
                                <a class="dropdown-item" href="<?= $this->url->get('ticket/active') ?>">Active Ticket <span class="badge badge-center rounded-pill bg-primary ms-2"><?= $cat ?></span></a>
                ...
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt4">
                                <a class="dropdown-item" href="<?= $this->url->get('clients') ?>">View</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt4">
                                <a class="dropdown-item" href="<?= $this->url->get('knowladge') ?>">View</a>
                                <a class="dropdown-item" href="<?= $this->url->get('knowladge/add') ?>">Add New</a>
                            </div>
                        </div>
                    </div>
