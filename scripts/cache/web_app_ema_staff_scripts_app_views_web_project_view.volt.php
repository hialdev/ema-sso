...
<div class="container-xxl flex-grow-1 container-p-y">  
    <div class="py-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <a href="<?= $this->url->get('project') ?>" class="d-inline-flex align-items-center gap-2 mb-3"><span class="iconify fs-2" data-icon="ion:arrow-back-circle"></span> Back to Projects</a>
            <a href="/project/<?= $project->slug ?>/edit" class="btn btn-outline-secondary d-inline-flex align-items-center gap-2"><span class="iconify" data-icon="akar-icons:edit"></span>Edit Project</a>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex gap-2 justify-content-between">
                            ...
                            <a href="/project/<?= $project->slug ?>/task/add" class="btn btn-outline-secondary">Add New</a>
                        </div>
                        <hr>
                        <ul class="list-unstyled">
                            <?php $v98225786980606784931iterated = false; ?><?php foreach ($project->Tasks as $task) { ?><?php $v98225786980606784931iterated = true; ?>
                            <li class="mb-2 d-flex align-items-center gap-2 text-<?= $task->Status->css ?>">
                                ...
                                <div class="dropdown ms-auto">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="/project/<?= $project->slug ?>/task/<?= $task->id ?>/edit"
                                ...
                                <div class="modal fade" id="confirmDelete" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="confirmDeleteTitle">Hapus Task : <?= $task->name ?>?</h5>
                                                <button
                                                    type="button"
                                                    class="btn-close"
                                                    data-bs-dismiss="modal"
                                            ...
                                            <div class="modal-body">
                                                <p>Task yang dihapus tidak dapat dikembalikan lagi.</p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                                                    Batal
                                                </button>
                                                <a href="/project/<?= $project->slug ?>/task/<?= $task->id ?>/delete" class="btn btn-primary">Ya, Hapus</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php } if (!$v98225786980606784931iterated) { ?>
                            <li>
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table">
                            ...
                            <tbody class="table-border-bottom-0">
                                <?php $v98225786980606784931iterated = false; ?><?php foreach ($tickets as $ticket) { ?><?php $v98225786980606784931iterated = true; ?>
                                <tr>
