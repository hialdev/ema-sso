...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="py-3">
        <h4># All Your Ticket <span class="badge badge-center rounded-pill bg-primary ms-2">6</span></h4>
        <form action="">
                ...
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td class="border-0">Project 1</td>
                            <td class="border-0"><span class="badge bg-label-danger">High</span></td>
                            <td class="border-0"><span class="badge bg-label-success me-1">completed</span></td>
                            <td class="border-0"><a href="./ticket-view.html" class="btn btn-primary">View</a></td>
                        </tr>
                        <tr>
                            <td colspan="10">
