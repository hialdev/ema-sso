...
class Mailer extends Phalcon\Di\Injectable
{
     ...
     * @throws Exception
     */
    public function send($to, $subject, $body, $cc = [], $bcc = [], $attachments = [], $setting = null)
    {
        ...
        if ($mailer == self::SWIFT_MAILER)
            return $this->SwiftMailerSend($to, $subject, $body, $cc, $bcc, $attachments, $setting);

        return $this->PhpMailerSend($to, $subject, $body, $cc, $bcc, $attachments, $setting);
    }

    public function SwiftMailerSend ($to, $subject, $body, $cc = [], $bcc = [], $attachments = [], $setting = null)
    {
        // Settings
        $mailSettings = $setting?:$this->config->email;
    ...
    public function PHPMailerSend ($recipients, $subject, $body, $cc = [], $bcc = [], $attachments = [], $setting = null)
    {
        $mailSettings = $setting?:$this->config->email;
        ...
        try {
            ...
            else $mail->addAddress($recipients);
