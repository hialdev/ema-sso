...
class TicketController extends BaseAppController
{
    ...
    public function indexAction()
    {
        ...
        //Get Clients Account
        $tc = Account::findByRoleSlug("client");
        ...
        $query = ['q'=>$qq,'p'=>(string) $qp,'s'=>(string) $qs,'c'=>(string) $qc];
        $opt = ['p'=>$tp,'s'=>$ts,'c'=>$tc];
    ...
    {
        //Get Clients Account
        $tc = Account::findByRoleSlug("staff");
        ...
        $chats = Chat::find([
            'conditions' => 'ticket_id in ({t:array}) AND account_id in ({c:array})',
            'bind' =>
            [
                't' => $ta,
                'c' => $c,
