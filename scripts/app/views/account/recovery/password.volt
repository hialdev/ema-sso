        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <div class="text-center mb-1">
                    ...
                    <span class="d-block text-muted m-bottom-20">Silakan ubah password anda</span>
                </div>
                ...
                <div class="form-group form-group-feedback form-group-feedback-left">
                    <input type="password" class="form-control" required name="again" placeholder="Ulangi Password">
                    <div class="form-control-feedback">
                        <i class="icon-lock2 text-muted"></i>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-danger btn-block btn-sm">Simpan Password <i class="icon-circle-right2 ml-2"></i></button>
                </div>
