        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <div class="text-center mb-1">
                    ...
                    <h5 class="mb-0">Verifikasi Alamat Email</h5>
                    <div class="mb-2 text-muted">sebagai <b>{{account.name}}</b></div>

                    <div class="d-block mb-2">Untuk login menggunakan OTP<br>Alamat Email harus diverifikasi dahulu.</div>
                    <div class="d-block mb-2">Silakan masukkan Kode Verifikasi yang sudah dikirimkan ke email <b>{{unverified}}</b></div class="d-block mb-2">
                </div>
