...
<div class="modal" data-keyboard="true" id="select-orangtua-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header align-items-center d-flex">
                <h5 class="modal-title font-weight-bold"><i class="icon-file-check mr-1"></i> Pilih Orangtua</h5>
                <div class="d-flex justify-content-between">
                    <div class="input-group">
            ...
            <div class="w-100 table-container" style="min-height: 400px;">
                <table class="table table-orangtua table-condensed table-cursor table-hover">
                    <thead>
                        <tr>
                            <th width="100">ID Orangtua</th>
                            <th>Nama Ayah</th>
            ...
            <div class="modal-footer">
                <div>
                    ...
                    <button type="button" data-role="orangtua" data-role-name="Orangtua Siswa" class="btn btn-primary btn-set-role btn-xs"><i class="icon-paperplane mr-2"></i> Pilih Orangtua</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" style="min-height:100px;">
            <form class="form" role="form" id="form_phone">
                ...
                <p>Kode verifikasi akan dikirimkan melalui Telegram</p>
            </form>
        </div>
        <div class="modal-footer">
            <button type="button" data-dismiss="modal" class="btn cancel btn-xs btn"><i class="fa fa-undo"></i> Batal</button>
